    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('restaurant and coffee shop', 'restaurant and coffee shop'), ('Cinemas and theaters and concerts', 'Cinemas and theaters and concerts'), ('Amusement Park', 'Amusement Park'), ('shopping center', 'shopping center'), ('female', 'Sports'), ('Park and free space', 'Park and free space'), ('Other', 'Other')], default='STRING', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('center_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='users.Center')),
            ],
        ),
        migrations.CreateModel(
            name='Interest',
